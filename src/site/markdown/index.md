...
* Uses [CONGA][conga] to manage AEM configuration and package deployment by default, but this is optional. If disabled, AEM configurations and "all" package deployment are managed via content packages.
